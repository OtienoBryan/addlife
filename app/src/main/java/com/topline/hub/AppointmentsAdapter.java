...
public class AppointmentsAdapter extends RecyclerView.Adapter<AppointmentsAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        final String latitude = apps.get(position).getLatitude();
        final String longitude = apps.get(position).getLongitude();
        final String status = apps.get(position).getStatus();
        final String checkIn= apps.get(position).getCheckin();
        ...
        final String myTime = apps.get(position).getCheckin();
...
//        holder.day.setText(apps.get(position).getDay());
        holder.start_time.setText(apps.get(position).getStartTime());
        holder.end_time.setText(apps.get(position).getEndTime());
        holder.status.setText(apps.get(position).getStatus());
        holder.charges.setText(apps.get(position).getAgenda());
        holder.paid.setText(apps.get(position).getCheckin());
        holder.checkin.setText(apps.get(position).getCheckin());
